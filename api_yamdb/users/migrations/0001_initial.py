# Generated by Django 3.2 on 2024-10-19 11:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='Введите имя')),
                ('last_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='Введите фамилию')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Электронная почта')),
                ('bio', models.CharField(blank=True, max_length=100, null=True, verbose_name='Биография')),
